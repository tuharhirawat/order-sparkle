              ...
              {order.paymentStatus && order.paymentStatus !== "Refunded" && (
                <div className="mb-5 grid gap-3 sm:grid-cols-2">
                  <div className="rounded-sm border border-border p-4">
                    <p className="text-[0.65rem] uppercase tracking-[0.16em] text-muted-foreground">Amount paid</p>
                  ...
                  <div className="rounded-sm border border-border p-4">
                    <p className="text-[0.65rem] uppercase tracking-[0.16em] text-muted-foreground">Amount pending</p>
